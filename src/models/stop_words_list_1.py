...
stop_words_1 = [
    ...
    'waterfront view', 'task', 'benefit','day', 'seattle waterfront', 'connections', 'model',
    'subsidiaries', 'principles', 'scalability', 'project', 'management offerings', 'description',
    'sites', 'guidelines', 'businesss', 'citizen ways', 'government law', 'payments', 'software',
    'enforcement world', 'organization', 'table tennis', 'fit', 'thousands', 'works', 'minority',
    'partners', 'waterfront views', 'prevention hood'
]
